          ...
          <div className="lg:col-span-7 p-6 sm:p-10 md:p-16 xl:p-20 flex flex-col justify-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-5 pt-4">
                <button
                  onClick={() => window.location.href = '/clinic/allclinics'}
                  className="group bg-white hover:bg-slate-50 text-[#3d3f96] px-8 py-4.5 rounded-2xl font-black text-base flex items-center gap-2.5 shadow-[0_15px_35px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_45px_rgba(0,0,0,0.25)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">
                ...
                <button
                  ...
                  className="text-white font-bold text-sm border-b-2 border-white/20 hover:border-white hover:text-sky-200 transition-all duration-300 pb-1.5">
                  Learn More About Us
                </button>
              </motion.div>
            </motion.div>
