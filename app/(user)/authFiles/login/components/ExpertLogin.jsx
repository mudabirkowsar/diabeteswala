  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const credentials = { 
        email: email.trim(), 
        password: password,
        category: "Food" // Explicitly pass verified Food category parameter
      };

      const response = await FoodAPI.loginFoodPartner(credentials);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-[2rem] max-w-md w-full overflow-hidden shadow-2xl border border-gray-100 p-8 text-center relative">
            ...
            <p className="text-xs text-gray-400 mt-3 leading-relaxed">
              Your food partner application is currently undergoing verification by our administrators. This process typically takes 24-48 hours.
            </p>
      ...
      {statusModal === 'Incomplete' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-[2rem] max-w-md w-full overflow-hidden shadow-2xl border border-gray-100 p-8 text-center relative">
            ...
            <p className="text-xs text-gray-400 mt-3 leading-relaxed">
              Your account exists, but valid FSSAI and operational kitchen credentials are required before listing your kitchen services.
            </p>
            <div className="bg-blue-50/50 border border-blue-100/50 rounded-2xl p-4 my-5 text-blue-800 text-xs font-semibold">
              Complete documentation setup to list your kitchen on our network.
            </div>
      ...
      {statusModal === 'Rejected' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-[2rem] max-w-md w-full overflow-hidden shadow-2xl border border-gray-100 p-8 text-center relative">
            ...
            <p className="text-xs text-gray-400 mt-3 leading-relaxed">
              The administration system was unable to verify your kitchen credentials.
            </p>
