...
const PharmacyRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            category: "Pharmacy", // Category is strictly validated as "Pharmacy"
        ...
        try {
            setLoading(true);
            const response = await PharmacyAPI.registerPharmacy(payload);
            ...
            if (response.success) {
                ...
                // Redirect directly to the documents upload page for Pharmacy Vendors
