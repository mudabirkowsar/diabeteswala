...
import LabAPI from '../../../../services/LabVendorAPI'; // Service file mapped to LabVendorAPI.js
...
const LabsRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            category: "Lab", // Category is strictly validated as "Lab"
        ...
        try {
            setLoading(true);
            const response = await LabAPI.registerLab(payload);

            if (response.success) {
                triggerNotification(response.message || "Registered successfully. Please upload documents.", "success");
                
                // If there's a token returned on creation, preserve it under labToken
                if (response.token) {
                    localStorage.setItem('labToken', response.token);
                }

                // Redirect directly to the document upload page for Lab Vendors
            ...
            <form onSubmit={handleSubmit} className="space-y-4 antialiased">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Lab / Pathlab Name</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="e.g. Apollo Pathlabs"
