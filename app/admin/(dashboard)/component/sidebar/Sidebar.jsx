                    ...
                    <>
                        ...
                        {openMenu === "others" && isExpanded && (
                            <div className="flex flex-col gap-1 mt-1 mb-1 pl-4 border-l-2 border-gray-100 transition-all duration-200">
                                ...
                                <Link href="/admin/others/managepeakcharge" className={`p-2 px-3 rounded-lg text-sm transition-all duration-200 flex items-center gap-2 ${isActive("/admin/others/managepeakcharge") ? "bg-[#3D3F96]/[0.06] text-[#3D3F96] font-semibold" : "text-gray-500 hover:bg-gray-50 hover:text-gray-900"}`}>
                                    <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: isActive("/admin/others/managepeakcharge") ? theme.primary : "#D1D5DB" }} />
                                    Manage Peak Charges
                                </Link>
                                ...
                                <Link href="/admin/others/managereshcedulelimit" className={`p-2 px-3 rounded-lg text-sm transition-all duration-200 flex items-center gap-2 ${isActive("/admin/others/managereshcedulelimit") ? "bg-[#3D3F96]/[0.06] text-[#3D3F96] font-semibold" : "text-gray-500 hover:bg-gray-50 hover:text-gray-900"}`}>
