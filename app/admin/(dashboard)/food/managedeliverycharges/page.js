...
export default function DeliveryChargesConfigPage() {
    // Strictly isolate configuration to the Food platform
    const vendorType = 'Food';
        ...
        <div className="max-w-[1600px] mx-auto space-y-8 py-4 pb-12 antialiased select-none text-left">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-100 pb-5">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Food Logistics Pricing</h1>
                        <p className="text-xs text-slate-500 font-bold mt-1">Manage global payment thresholds, tax rates, express dispatch surcharges, and distance-based fees for the food platform [cite: custom_context].</p>
                    </div>
                </div>
            </div>
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border border-slate-200 shadow-sm">
                    ...
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Retrieving Food specifications...</p>
                </div>
            ) : (
                    ...
                    <div className="lg:col-span-5 space-y-4">
                        <div className="bg-white rounded-3xl p-6 border border-slate-150 shadow-sm space-y-4">
                            <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider block border-b border-slate-50 pb-2">
                                Active Policy Monograph (Food) [cite: custom_context]
                            </span>
                            ...
                            {activeConfig ? (
                                <div className="space-y-4 text-xs font-bold text-slate-600">
                                    ...
                                    {activeConfig.isRapidAvailable && (
                                        <div className="flex items-center justify-between p-3.5 bg-red-50/60 border border-red-200/60 rounded-2xl">
                                            <span className="text-[10px] text-red-600 font-black uppercase flex items-center gap-1.5 leading-none">
                                                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span>
                                                Express Delivery Active [cite: custom_context]
                                            </span>
                                            <strong className="text-red-600 text-sm font-mono">+ ₹{activeConfig.rapidCharge}</strong>
                                        </div>
                                    )}
                                </div>
                            ) : (
                    ...
                    <div className="lg:col-span-7">
                        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-150 shadow-sm">
                            <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider block border-b border-slate-50 pb-2 mb-5">
                                Configure Food logistics rates [cite: custom_context]
                            </span>
